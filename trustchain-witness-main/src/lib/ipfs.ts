...
export const PINATA_API_KEY = import.meta.env.VITE_PINATA_API_KEY || 'YOUR_PINATA_API_KEY_HERE';
export const PINATA_SECRET_KEY = import.meta.env.VITE_PINATA_SECRET_KEY || 'YOUR_PINATA_SECRET_KEY_HERE';
